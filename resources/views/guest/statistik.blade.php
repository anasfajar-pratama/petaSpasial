<x-layouts.guest>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <form method="GET" action="{{ url('/statistik-publik') }}" class="flex flex-wrap items-end gap-4">
                <div>
                ...
                @if ($tahunFilter || $districtFilter)
                    <a href="{{ url('/statistik-publik') }}" class="px-4 py-2 text-sm text-gray-600 border rounded-lg hover:bg-gray-100">Reset</a>
                @endif
            </form>
        </div>
        ...
        <div class="text-center mb-8">
            <a href="{{ url('/peta') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        new Chart(document.getElementById('chartByLayer'), {
            type: 'bar',
            data: {
