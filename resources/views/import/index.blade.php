    ...
    <div x-data="{ loading: false }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('import.geojson') }}" method="POST" enctype="multipart/form-data" @submit="loading = true" onsubmit="this.querySelector('button[type=submit]').disabled=true">
                    @csrf
                    <div class="mb-4">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('import.csv') }}" method="POST" enctype="multipart/form-data" @submit="loading = true" onsubmit="this.querySelector('button[type=submit]').disabled=true">
                    @csrf
                    <div class="mb-4">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('import.shp') }}" method="POST" enctype="multipart/form-data" @submit="loading = true" onsubmit="this.querySelector('button[type=submit]').disabled=true">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Layer Tujuan</label>
                        <select name="layer_id" class="w-full border rounded-lg px-3 py-2" required>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('import.kml') }}" method="POST" enctype="multipart/form-data" @submit="loading = true" onsubmit="this.querySelector('button[type=submit]').disabled=true">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Layer Tujuan</label>
                        <select name="layer_id" class="w-full border rounded-lg px-3 py-2" required>
        ...
        <div class="bg-white rounded-lg shadow p-6 mt-6">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('import.contoh', 'contoh-titik.geojson') }}" class="text-sm text-blue-600 hover:underline">Titik (GeoJSON)</a>
