...
class LayerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $layers = [
            ...
            ['nama' => 'Sistem Infrastruktur Energi', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#ff9800', 'order' => 15, 'icon_marker' => '/icons/esri/gardu-listrik.png'],
            ['nama' => 'Sistem Infrastruktur Perkotaan', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#9c27b0', 'order' => 16],
            ['nama' => 'Sistem Infrastruktur Sumber Daya Air', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#2196f3', 'order' => 17, 'icon_marker' => '/icons/esri/bangunan-sumber-daya-air.png'],
            ['nama' => 'Sistem Infrastruktur Telekomunikasi', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#607d8b', 'order' => 18, 'icon_marker' => '/icons/esri/menara-base-transceiver-station-bts.png'],
            ['nama' => 'Sistem Infrastruktur Transportasi', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#795548', 'order' => 19, 'icon_marker' => '/icons/esri/halte.png'],
            ...
            ['nama' => 'Sistem Pusat Pelayanan', 'kategori' => 'Tata Ruang', 'geom_type' => 'Point', 'warna' => '#ff5722', 'order' => 24, 'icon_marker' => '/icons/esri/pusat-pelayanan-kota.png'],
        ];
        ...
        foreach ($layers as $item) {
            ...
            Layer::create([
                ...
                'warna' => $item['warna'],
                'order' => $item['order'],
                'icon_marker' => $item['icon_marker'] ?? null,
                'created_by' => $admin->id,
                'is_active' => true,
                'opacity' => 1.00,
            ]);
